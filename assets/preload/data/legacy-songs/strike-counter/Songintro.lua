    ...
    IntroSubText2Size = 15
    IntroTagColor = 'FF7F27' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Strike Counter', 300, -305-IntroTagWidth, 200)
        ...
        makeLuaText('JukeBoxSubText2', 'Loxo Highscore', 300, -305-IntroTagWidth, 240)
